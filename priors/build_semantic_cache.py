...
def main():
    ...
    parser.add_argument('--save_dir', default='sgtfgcn_release/priors/cache')
    ...
    parser.add_argument('--skip_gap', action='store_true',
                        help='Do not rebuild gap_cache.pt. Useful when using GPT-4o descriptions generated by gen_ntu60_gap_cache.py.')
    parser.add_argument('--skip_ljp', action='store_true',
                        help='Do not rebuild ljp_cache.pt.')
